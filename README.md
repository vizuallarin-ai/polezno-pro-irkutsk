# Иркпортал (ранее — Полезно про Иркутск)

Авторский навигатор по Иркутску и Байкалу. Next.js 16 + Payload CMS 3.

**Модель продаж:** заявка через форму → ручное согласование с Алёной. Онлайн-оплата на сайте не используется.

**Сейчас (2026-09):** платформа и lead-pipeline готовы; коммерческое ядро (опубликованные маршруты/экскурсии) ждёт материалов владельца. Пустые каталоги (фото, сувениры, AR) скрыты из нав/sitemap до появления published-контента. Следующий шаг без CMS-контента — деплой ветки `phase15-commercial-core-launch` (Gate D) или ожидание Gate C.

Roadmap: `docs/phase15-gate-c-runbook.md`, `docs/phase15-gate-d-runbook.md`.
