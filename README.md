...
**Сейчас (2026-09):** платформа и lead-pipeline готовы; коммерческое ядро наполняется. До запуска **все разделы видны** в меню и на витрине (пустые каталоги показывают prelaunch-состояние) — для согласования с заказчиком.
